...
public class Translator {
	...
	if (classMapping != null) {
		...
		if (translatedInnerClassName != null) {
		    ...
		    String translatedOuterClassName = m_direction.choose(classMapping.getDeobfName(),
	...
	if (classMapping != null) {
	    // look for the field
	    String translatedName = m_direction.choose(classMapping.getDeobfFieldName(in.getName()),
	...
	if (classMapping != null) {
	    ...
	    if (methodMapping != null) {
		return m_direction.choose(methodMapping.getDeobfArgumentName(in.getIndex()),
	...
	if (classMapping != null && classEntry.isInnerClass()) {
	    classMapping = m_direction.choose(classMapping.getInnerClassByObf(classEntry.getInnerClassName()),
