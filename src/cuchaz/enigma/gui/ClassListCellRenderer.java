...
public class ClassListCellRenderer implements ListCellRenderer<String> {
    ...
    @Override
    public Component getListCellRendererComponent(JList<? extends String> list, String className, int index,
	    boolean isSelected, boolean hasFocus) {
	JLabel label = (JLabel) m_defaultRenderer.getListCellRendererComponent(list, className, index, isSelected,
		hasFocus);
