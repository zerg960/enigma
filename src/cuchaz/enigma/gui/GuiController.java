...
public class GuiController {
	...
	return new ReadableToken(m_index.getLineNumber(token.start), m_index.getColumnNumber(token.start),
	...
	ClassInheritanceTreeNode rootNode = m_deobfuscator.getJarIndex().getClassInheritance(
		m_deobfuscator.getTranslator(TranslationDirection.Deobfuscating), obfClassEntry);
	...
	MethodInheritanceTreeNode rootNode = m_deobfuscator.getJarIndex().getMethodInheritance(
		m_deobfuscator.getTranslator(TranslationDirection.Deobfuscating), obfMethodEntry);
	...
	FieldReferenceTreeNode rootNode = new FieldReferenceTreeNode(
		m_deobfuscator.getTranslator(TranslationDirection.Deobfuscating), obfFieldEntry);
	...
	BehaviorReferenceTreeNode rootNode = new BehaviorReferenceTreeNode(
		m_deobfuscator.getTranslator(TranslationDirection.Deobfuscating), obfBehaviorEntry);
	rootNode.load(m_deobfuscator.getJarIndex(), true);
	return rootNode;
    }
	...
	if (tokens.isEmpty()) {
	    ...
	    System.err.println(String
		    .format("WARNING: no tokens found for %s in %s", deobfReference, m_currentObfClass));
	} else {
