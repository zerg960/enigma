...
public class MethodParametersAttribute extends AttributeInfo {
	...
	// uint8 num_params
	// for each param:
	// uint16 name_index -> points to UTF8 entry in constant pool, or 0 for
	// no entry
	...
	// the writeShort(), writeByte() methods will read 16,8 low-order bits
	// from the int argument
	// as long as the int argument is in range of the unsigned short/byte
	// type, it will be written as an unsigned short/byte
	// if the int is out of range, the byte stream won't look the way we
	// want and weird things will happen
