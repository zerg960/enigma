...
public enum InfoType {
    Utf8Info(1, 0), IntegerInfo(3, 0), FloatInfo(4, 0), LongInfo(5, 0), DoubleInfo(6, 0), ClassInfo(7, 1) {
	@Override
	...
	public boolean subIndicesAreValid(ConstInfoAccessor entry, ConstPoolEditor pool) {
	    ...
	    return classEntry != null && classEntry.getTag() == ClassInfo.getTag() && nameAndTypeEntry != null
		    && nameAndTypeEntry.getTag() == NameAndTypeInfo.getTag();
	}
    },
    MethodRefInfo(10, 2) // same as FieldRefInfo
    {
	@Override
	public void gatherIndexTree(Collection<Integer> indices, ConstPoolEditor editor, ConstInfoAccessor entry) {
    ...
    InterfaceMethodRefInfo(11, 2) // same as FieldRefInfo
    {
	@Override
	public void gatherIndexTree(Collection<Integer> indices, ConstPoolEditor editor, ConstInfoAccessor entry) {
	    FieldRefInfo.gatherIndexTree(indices, editor, entry);
	...
	public boolean subIndicesAreValid(ConstInfoAccessor entry, ConstPoolEditor pool) {
	    ...
	    return nameEntry != null && nameEntry.getTag() == Utf8Info.getTag() && typeEntry != null
		    && typeEntry.getTag() == Utf8Info.getTag();
	}
    },
	...
	public boolean subIndicesAreValid(ConstInfoAccessor entry, ConstPoolEditor pool) {
	    ...
	    return typeEntry != null && typeEntry.getTag() == Utf8Info.getTag() && methodRefEntry != null
	...
	public boolean subIndicesAreValid(ConstInfoAccessor entry, ConstPoolEditor pool) {
	    ...
	    ConstInfoAccessor nameAndTypeEntry = pool.getItem(accessor.getNameAndTypeIndex());
	    return bootstrapEntry != null && bootstrapEntry.getTag() == Utf8Info.getTag() && nameAndTypeEntry != null
		    && nameAndTypeEntry.getTag() == NameAndTypeInfo.getTag();
	}
    };
